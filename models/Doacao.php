...
class Doacao extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['descricao', 'video'], 'string'],
            [['titulo'], 'string', 'max' => 255],
            [['id_doacao', 'id_instituicao'], 'integer'],
            [['file_imagem_capa', 'file_imagem_perfil'], 'image','extensions' => 'png, jpg, jpeg, gif', 'skipOnEmpty' => true, 'on' => 'update-photo-upload'],
            [['file_imagem_capa', 'file_imagem_perfil'], 'image','extensions' => 'png, jpg, jpeg, gif', 'skipOnEmpty' => false, 'on' => 'insert-photo-upload'],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'file_imagem_perfil' => 'Imagem de Perfil',
            'video' => 'Vídeo',
            'imagem_capa' => 'Imagem de Capa',
            'file_imagem_capa' => 'Imagem de Capa'
        ];
    }
    ...
    {
        $this->file_imagem_perfil = UploadedFile::getInstance($this, 'file_imagem_perfil');
        $this->file_imagem_capa = UploadedFile::getInstance($this, 'file_imagem_capa');
    ...
    public function afterSave($insert, $changedAttributes)
    {
      ...
      if($insert) {
        ...
        if(!empty($changedAttributes['imagem_perfil'])) {
          if ($this->imagem_perfil) {
            $this->file_imagem_perfil->saveAs('uploads/' . $this->imagem_perfil);
          }
        }

        if(!empty($changedAttributes['imagem_capa'])) {
